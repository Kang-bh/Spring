...
import org.blog.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import org.blog.config.oauth.OAuth2SuccessHandler;
...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.oauth2Login()
                ...
                // store status related with authorization request
        ...
        // except processing returning 401 status code when url is starting "/api"
